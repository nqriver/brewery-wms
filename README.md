...
## ScyllaDB
To start ScyllaDB with the configured keyspace navigate to `./scyllaDb` directory and run 
...
You can then execute your native executable with: `./build/breweryProductionBatch-wms-1.0-SNAPSHOT-runner`
